...
abstract class ApiResourceController extends Controller
{
    ...
    {
        $request->request->add(['method_type' => __FUNCTION__]);
        ...
        $per_page = !empty($input['per_page']) ? $input['per_page'] : $per_page; 
    ...
    {
        $messages = [
            "store" => class_basename($this->_repository->model->getModel())." created successfully.",
            "update" => class_basename($this->_repository->model->getModel())." updated successfully.",
            "destroy" => class_basename($this->_repository->model->getModel())." deleted successfully.",
        ];
